...
public class Level_20_Manage_Data_Faker_Part_II extends BaseTest {

	@Parameters({ "browser", "firstName", "lastName", "emailAddress", "password", "day", "month", "year" })
	@BeforeClass
	public void beforeClass(String browserName, String firstName, String lastName, String emailAddress, String password, String day, String month, String year) {
		driver = getBrowserDriver(browserName);
		homePage = PageGeneratorManager.getUserHomePage(driver);

		this.firstName = firstName;
		this.lastName = lastName;
		this.emailAddress = emailAddress + generateFakeNumber() + "@live.com";
